...
Worms : main.o graphics.o util.o level.o worm.o physObj.o item.o game.o anim.o team.o weapon.o ./Queue/queue.o
...
game.o : game.c game.h item.h worm.h ./Queue/queue.h util.h
...
weapon.o : weapon.c weapon.h physObj.h level.h

main.o : main.c util.h graphics.h level.h worm.h physObj.h item.h game.h anim.h team.h weapon.h ./Queue/queue.h

clean:
	rm -f main.o graphics.o util.o level.o worm.o physObj.o item.o game.o anim.o team.o weapon.o Worms ./Queue/queue.o
